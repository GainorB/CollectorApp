                ...
                <div className="LoginForm">
                    ...
                    <form onSubmit={this.props.handleLogin} >
                        <div><p className="tooltip"><label htmlFor='username'>Username</label></p>
                            <input type="text" name="username" onBlur={this.props.handleChange} required/></div>

                        <div><p className="tooltip"><label htmlFor='password'>Password</label></p>
                            <input type="password" name="password" onBlur={this.props.handleChange} required/></div>
            ...
            return (
                <div className="ForgotForm">
                    ...
                    <form onSubmit={this.props.handleForgotten}>
                        ...
                        <p><input type="email" name="email" placeholder="email" onBlur={this.props.handleChange} required/></p>
